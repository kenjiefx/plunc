...
export function setStagingElementInnerHtml(
  ...
  if (stagingElement.$plStgCS) {
    throw new PluncError<SettingInnerHtmlToCommittedStagingElementError>(
      "ERR1",
    );
  }
...
export function getStagingElementInnerHtml(
  ...
  if (stagingElement.$plStgCS) {
    throw new PluncError<GettingInnerHtmlFromCommittedStagingElementError>(
      "ERR2",
    );
  }
...
export function commitStagingElementTo(
  ...
  if (stagingElement.$plStgCS) {
    throw new PluncError<ReCommittingStagingElementError>("ERR3");
  }
